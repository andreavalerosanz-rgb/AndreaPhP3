...
@section('content')
    <div class="max-w-4xl mx-auto space-y-10 pb-20">
        ...
        <div class="relative overflow-hidden rounded-[2.5rem] bg-slate-900 p-10 lg:p-14 shadow-2xl text-white">
            <div class="absolute -left-10 -top-10 h-40 w-40 bg-primary/20 rounded-full blur-3xl"></div>
            <div class="relative z-10 flex justify-between items-center">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-3xl font-black italic uppercase tracking-tight italic">Nuevo <span
                                class="text-primary underline underline-offset-8">Vehículo</span></h1>
                        <p class="text-slate-500 font-bold uppercase text-[10px] mt-2 tracking-widest italic">Añadir unidad
                            a la flota operativa</p>
                    </div>
                </div>
        ...
        <div class="bg-white border border-slate-100 rounded-[3rem] p-10 lg:p-14 shadow-xl">
            ...
            @if ($errors->any())
                <div
                    ...
                    <div class="flex items-center gap-2 font-black uppercase text-[10px] tracking-widest text-red-800 mb-2">
                        <i data-lucide="alert-circle" class="w-4 h-4"></i> Error al registrar vehículo
                    </div>
            ...
            <form action="{{ route('admin.fleet.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="form-control md:col-span-2">
                        ...
                        <input type="text" name="label" value="{{ old('label') }}"
                            placeholder="Ej: Mercedes-Benz Clase V VIP"
                    ...
                    <div class="form-control">
                        <label class="label font-black text-[10px] text-slate-400 uppercase tracking-widest mb-1">Email del
                            Conductor</label>
                        <input type="email" name="driver_identity" value="{{ old('driver_identity') }}"
                            placeholder="conductor@islatransfers.com"
                    ...
                    <div class="form-control">
                        <label class="label font-black text-[10px] text-slate-400 uppercase tracking-widest mb-1">Matrícula
                            (Clave Interna)</label>
                        <input type="text" name="access_key" value="{{ old('access_key') }}" placeholder="1234ABC"
                ...
                <div class="pt-6">
                    <button type="submit"
                        ...
                        Registrar en la Flota <i data-lucide="check" class="w-4 h-4 ml-2"></i>
                    </button>
                </div>
            </form>
        </div>
